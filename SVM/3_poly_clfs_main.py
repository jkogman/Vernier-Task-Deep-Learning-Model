...
1 D=0, Prior = uniform (93%)
2 D=100, Prior = delta
3 D=100, Prior = uniform (93%)
'''
...
for i in range(N_classifiers):
    ...
    filename = f'3_Poly model num {i+1}.joblib'
...
np.savetxt("Accuracy_3_poly_clfs.csv", acc_per ,fmt='%10.5f', delimiter=",")